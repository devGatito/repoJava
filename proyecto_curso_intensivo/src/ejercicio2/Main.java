...
public class Main {
	...
	public static void main(String[] args) {
		...
		Contacto newContacto = new Contacto(1,"\n Elias", "Lara ", "7621240911","eliasmisaelsotojimenez1@gmail.com","calle de lomas","Empresario");
		Contacto newContacto3 = new Contacto(2,"\n Lola", "Soto ", "7621240911","eliasmisaelsotojimenez1@gmail.com","calle de lomas","Cliente");

		Contacto newContacto1 = new Contacto(3,"\n Steren", "Rosa", "305684","test@gmail.com","calle de pedro martin","Empresario");
		Contacto newContacto2 = new Contacto(4,"\n Batman", "Mon", "34335656","eliasmisaelsotojimenez1@gmail.com","calle de pedro martin","Empresarioi");
		...
		lista.stream().filter(a-> a.getTelefono() == buscarNumero).forEach(b -> {
			System.out.println("\n se encontro el telefono por numero de " + b);
		});;
